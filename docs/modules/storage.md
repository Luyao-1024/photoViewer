...
When the Photos `photos_grid_backend` is `"gridview"`, that same startup list
is only an instant-first-paint seed and domain-event signal. `VirtualMediaGrid`
